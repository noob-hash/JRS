...
public class DataInitializer {
    ...
    public CommandLineRunner populateData(
        ...
        return args -> {
            ...
            company.setDescription("Leading provider of innovative technology solutions.");
            ...
            candidateProfile.setDescription("Experienced Java developer with expertise in Spring Boot.");
            ...
            application2.setCoverLetter("I would like to apply for the frontend position...");
